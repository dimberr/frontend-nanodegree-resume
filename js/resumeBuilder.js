function fillData(data) {
    ...
    bio = {
        ...
        "skills": [data.skills[0].name, data.skills[1].name, data.skills[2].name],
        "welcomeMessage": "Welcome",
        "biopic": "images/fry.jpg",
        "contacts": {
            "mobile": data.basics.phone,
            "email": data.basics.email,
            "github": data.basics.website,
    ...
    data.education.forEach(function(school) {
        var i = 0;
        education.schools[i].name = school.institution;
        education.schools[i].location = school.area;
        education.schools[i].degree = school.studyType;
        education.schools[i].dates = school.startDate;
        education.schools[i].url = "url";
        education.schools[i].majors = ["CS", "Psy"];
        i++;
    });
